...
public class DishServiceImpl implements DishService {
    ...
    public Dish update(Long id, String dishId, String name, String cuisine, int preparationTime,Long chefId) {
        ...
        Dish dish = findById(id);                           //Ovaj metod go reshavet na poinakov nacin,
        Chef chef = chefService.findById(chefId);
        dish.setDishId(dishId);                          //Pravat sosema nov dish objekt i mu go davaat istoto id
        dish.setName(name);                              //Mislam vaka deka e podobro bidejki istiot objekt dobiva update
    ...
    @Override
    public void toggleLiked(Long id) {
//        dishRepository.toggleLiked(id);
